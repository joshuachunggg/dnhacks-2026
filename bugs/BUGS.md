...
| B-003 | high | No deterministic backend tool service yet | Backend | TODO | Run an engineering scenario from current SiteGraph state | `apps/server` | Fixture-provided results | Add typed deterministic engineering and cost tool endpoints | Changed SiteGraph inputs produce newly computed results |
